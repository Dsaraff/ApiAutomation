...
public class Put_CatalogProductupdate {
@Test
public void renameProduct()
{
	String payload1 = "{\n"
			+ "  \"itemName\": \"RA_Product2.1\",\n"
	...
	//response
	Response responseResult = request.put("https://api.kicchin.com/service-provider-service/rest/serviceproviders/814CDACB-BC4F-4B28-B12C-ABFCB7DCCA6A/products/7F291CAF-83EA-45B3-B3D4-49FD6D0348F8");	
